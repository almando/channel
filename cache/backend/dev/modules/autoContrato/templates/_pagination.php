<div class="sf_admin_pagination">
  <a class="laigu_ajax" href="<?php echo url_for('@contrato') ?>?page=1">
  ...
  <a class="laigu_ajax" href="<?php echo url_for('@contrato') ?>?page=<?php echo $pager->getPreviousPage() ?>">
  ...
  <?php foreach ($pager->getLinks() as $page): ?>
    <?php if ($page == $pager->getPage()): ?>
      <?php echo $page ?>
    <?php else: ?>
      <a class="laigu_ajax" href="<?php echo url_for('@contrato') ?>?page=<?php echo $page ?>"><?php echo $page ?></a>
    <?php endif; ?>
  <?php endforeach; ?>

  <a class="laigu_ajax" href="<?php echo url_for('@contrato') ?>?page=<?php echo $pager->getNextPage() ?>">
  ...
  <a class="laigu_ajax" href="<?php echo url_for('@contrato') ?>?page=<?php echo $pager->getLastPage() ?>">
