...
<?php endforeach; ?>
  ...
  [?php version_compare(SYMFONY_VERSION, "1.3.0") >= 0 ? $form = new BaseForm() : $form = new sfForm() ; if ($form->isCSRFProtected()): ?]
    <input type="hidden" name="[?php echo $form->getCSRFFieldName() ?]" value="[?php echo $form->getCSRFToken() ?]" />
  [?php endif; ?]
  <input type="submit" value="[?php echo __('go', array(), 'sf_admin') ?]" class="laigu_ajax" />
</li>
<?php endif; ?>
